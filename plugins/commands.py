...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        if message.command[1] != "subscribe":
            try:
                ...
                btn.append([InlineKeyboardButton("↻ Tʀʏ Aɢᴀɪɴ", callback_data="close_data")])
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            btn = [[
                InlineKeyboardButton("ʀᴇǫᴜᴇꜱᴛ ᴀɢᴀɪɴ", callback_data='close_data')
            ]]
